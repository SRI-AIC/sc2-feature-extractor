...
class ExtractorProcessor(DebugReplayProcessor):
    ...
    def __init__(self, extractor_listener: DebugStepListener, agent_interface_format: AgentInterfaceFormat):
        """
        ...
        self._extractor = extractor_listener
...
class ExtractorListener(DebugStepListener):
    ...
    def __init__(self, meta_extractor: MetaExtractor, extractors: Dict[str, List[FeatureExtractor]], output_dir: str):
        """
    ...
    def finish_replay(self):
        ...
        output_file = os.path.join(self.output_dir, f'{get_file_name_without_extension(self.replay_path)}.csv')
